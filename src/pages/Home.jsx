      ...
      <section className="sig-section" id="signatures">
        <div className="container">
          ...
          >
            ...
            <p className="sig-sub">Crafted favorites with a Singh twist. Clean flavors, premium feel.</p>
          </motion.div>

          <div className="sig-grid">
            {[
              { title: "Masala Chai Latte", desc: "Warm spices, silky milk, cozy finish.", meta: "Best Seller" },
              { title: "Saffron Cold Brew", desc: "Smooth cold brew with a subtle saffron note.", meta: "Limited" },
              { title: "Cardamom Cappuccino", desc: "Classic cappuccino with a light cardamom lift.", meta: "Signature" },
            ].map((item) => (
              <motion.article
                key={item.title}
                className="sig-card"
        ...
        <div className="container contact-grid">
          <div className="contact-left">
            ...
            <p className="contact-text">
              A cozy neighborhood coffee spot built for great conversations, smooth espresso, and warm vibes.
            </p>
            ...
            <div className="contact-info">
              ...
              <div>
                <span className="contact-icon">✉</span>
                <span>singhcoffeehouse@gmail.com</span>
              </div>
            </div>

            <div className="socials">
              <a href="https://www.instagram.com/_ikjotsingh" target="_blank" rel="noreferrer">Instagram</a>
              <a href="https://twitter.com/" target="_blank" rel="noreferrer">Twitter</a>
              <a href="https://www.google.com/maps/search/?api=1&query=Tempe+Arizona" target="_blank" rel="noreferrer">Google Maps</a>
            </div>
          </div>
          ...
          <div className="contact-form">
            ...
            <form
              onSubmit={async (e) => {
                ...
                try {
                  ...
                  const data = jsonBody || (textBody ? { error: textBody } : {});
                  ...
                  setContactError(error.message || "Unable to send message.");
                } finally {
            ...
            >
              ...
              {contactStatus && <div className="contact-status success">{contactStatus}</div>}
              {contactError && <div className="contact-status error">{contactError}</div>}
            </form>
          </div>
        </div>

        <div className="footer-bottom">© {new Date().getFullYear()} Singh Coffee House</div>
      </section>
